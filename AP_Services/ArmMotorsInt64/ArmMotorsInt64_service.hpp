...
#ifndef AP_SERVICES_ARMMOTORS_SERVICE_HPP_
#define AP_SERVICES_ARMMOTORS_SERVICE_HPP_
...
class ArmMotorsInt64_Service
    : public fastdds::dds::DataWriterListener
{
public:

    ArmMotorsInt64_Service(
    ...
    // Perform a request
    std::future<ArmMotorsInt64_Reply> request(
...
private:
    ...
    std::promise<ArmMotorsInt64_Reply>* promise_ = nullptr;
    bool server_;
    bool stop_;
    ...
    private:
        ...
        fastdds::dds::DataWriter* datawriter_;
        ArmMotorsInt64_Service* service_;
    };
...
#endif  // AP_SERVICES_ARMMOTORS_SERVICE_HPP_
