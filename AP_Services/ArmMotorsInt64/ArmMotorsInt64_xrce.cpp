    ...
    void* args)
{
    ...
    ucdr_serialize_int64_t(&reply_ub, result);
    ...
    char** argv)
{
    ...
    const char* participant_xml =
        ...
        "  <participant>"
        "    <rtps>"
        "      <name>ArmMotorsInt64_Server</name>"
        "    </rtps>"
        "  </participant>"
        "</dds>";
    ...
    const char* replier_xml =
        "<dds>"
        "  <replier profile_name=\"ArmMotorsInt64_Replier\""
        "      service_name=\"ArmMotorsInt64_Service\""
        "      request_type=\"ArmMotorsInt64_Request\""
        "      reply_type=\"ArmMotorsInt64_Reply\">"
        "  </replier>"
        "</dds>";
