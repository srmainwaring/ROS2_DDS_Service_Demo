...
#include "ArmMotors_service.hpp"

#include <ctime>
#include <chrono>


ArmMotors_Service::ArmMotors_Service(
        ...
        const uint32_t sleep)
{
    ...
    {
        stop_ = false;
        std::thread thread(&ArmMotors_Service::runThread, this, number, sleep);
        if (0 == number)
        {
...
void ArmMotors_Service::on_publication_matched(
...
void ArmMotors_Service::runThread(
...
void ArmMotors_Service::RequestListener::publisher(
        ArmMotors_Service* service,
...
void ArmMotors_Service::RequestListener::on_subscription_matched(
...
void ArmMotors_Service::RequestListener::on_data_available(
...
void ArmMotors_Service::ReplyListener::publisher(
        ArmMotors_Service* service)
{
    service_ = service;
}

void ArmMotors_Service::ReplyListener::on_subscription_matched(
        fastdds::dds::DataReader* /*datareader*/,
        const fastdds::dds::SubscriptionMatchedStatus& /*info*/)
{
    std::unique_lock<std::mutex> lock(service_->matched_mutex_);
...
void ArmMotors_Service::ReplyListener::on_data_available(
        fastdds::dds::DataReader* reader)
{
