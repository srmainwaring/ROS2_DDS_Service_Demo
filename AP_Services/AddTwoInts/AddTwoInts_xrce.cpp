    ...
    void* args)
{
    ...
    int64_t a;
    int64_t b;
    ucdr_deserialize_int64_t(ub, &a);
    ucdr_deserialize_int64_t(ub, &b);

    printf("Request received: (%" PRId64 " + %" PRId64 ")\n", a, b);
    ...
    char** argv)
{
    ...
    const char* replier_xml =
        "<dds>"
        "  <replier profile_name=\"AddTwoInts_Replier\""
        "      service_name=\"AddTwoInts_Service\""
        "      request_type=\"AddTwoInts_Request\""
        "      reply_type=\"AddTwoInts_Reply\">"
        "  </replier>"
        "</dds>";
