        ...
        char** argv)
{
    ...
    uint32_t count = 10;
    std::string service_name("AddTwoInts_Service");
    ...
    while (true)
    {
        ...
        switch (opt)
        {
            ...
            case 'h':
            {
                ...
                std::cout << "\t-n/--service_name\t(optional) Request/reply to/from a specific service (default: AddTwoInts_Service)" << std::endl;
                return 0;
            }
            default:
            {
