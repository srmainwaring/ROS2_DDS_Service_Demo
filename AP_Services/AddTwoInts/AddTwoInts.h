...
#ifndef _FAST_DDS_GENERATED_ADDTWOINTS_H_
#define _FAST_DDS_GENERATED_ADDTWOINTS_H_
...
/*!
 * @brief This class represents the structure AddTwoInts_Reply defined by the user in the IDL file.
 * @ingroup AddTwoInts
 */
class AddTwoInts_Reply
{
public:
     ...
     * @brief Default constructor.
     */
    eProsima_user_DllExport AddTwoInts_Reply();
    ...
    /*!
     * @brief Copy constructor.
     * @param x Reference to the object AddTwoInts_Reply that will be copied.
     */
    eProsima_user_DllExport AddTwoInts_Reply(
     ...
     * @param x Reference to the object AddTwoInts_Reply that will be copied.
     */
    eProsima_user_DllExport AddTwoInts_Reply& operator =(
            const AddTwoInts_Reply& x);
    ...
    /*!
     * @brief Comparison operator.
     * @param x AddTwoInts_Reply object to compare.
     */
    eProsima_user_DllExport bool operator ==(
...
#endif // _FAST_DDS_GENERATED_ADDTWOINTS_H_
