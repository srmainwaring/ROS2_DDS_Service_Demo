...
#ifndef AP_SERVICES_ADDTWOINTS_SERVICE_HPP_
#define AP_SERVICES_ADDTWOINTS_SERVICE_HPP_
...
public:
    ...
    // Perform a request
    std::future<AddTwoInts_Reply> request(
...
private:
    ...
    std::promise<AddTwoInts_Reply>* promise_ = nullptr;
    bool server_;
    bool stop_;
...
#endif  // AP_SERVICES_ADDTWOINTS_SERVICE_HPP_
